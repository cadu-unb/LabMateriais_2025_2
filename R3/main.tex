...
\begin{table}[h]
    ...
    \begin{tabular}{ >{\centering\arraybackslash}m{3cm}  >{\centering\arraybackslash}m{3cm} }
        \hline
        \rule{0pt}{3ex} \textbf{Indutância [$\mu H$]} & \rule{0pt}{3ex} \textbf{Fator de qualidade} \\ [7pt]
        \hline 
        \rule{0pt}{3ex} L = 128 & \rule{0pt}{3ex} Q = 2.6 \\[5pt]
        \hline
    \end{tabular}
\end{table}
...
\begin{equation*}
    \mathfrak{R} = \frac{50^2}{128\cdot10^{-6}} = 19.53125\cdot 10^6 \, \left[\frac{Ae}{Wb}\right]
\end{equation*}

\vspace{-.5cm}

\begin{equation*}
    \mu_f = \left[ \left( \mathfrak{R} - \frac{l_g}{\mu_0A} \right) \frac{A}{l_f} \right]^{-1}
\end{equation*}

A partir da relutância, foi possível determinar a permeabilidade magnética efetiva ($\mu_f$): 

$$\mu_f=4.50\cdot 10^{-5} \,\, \left[\frac{H}{m}\right]$$
...
\begin{enumerate}
    ...
    \item STREETMAN, Ben G.; BANERJEE, Sanjay Kumar. Solid State Electronic Devices. 7. ed. Harlow: Pearson, 2015.
